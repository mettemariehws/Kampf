...
<body>
  <div id="body">
    <div id="background">
      <div>
        <div>
          <div>
            <h1>Here you can see an overview of all the games played</h1>
            <p>
              Vi er en lille klub, men det betyder ikke vi skal gå ned på udstyr
              :-D Her er en oversigt og alle de kampe der spilles i klubben og
              hvem de skal spilles imod.
            </p>
          </div>
        </div>
      </div>
  ...
  <div id="footer">
    ...
    <p>
      &copy; Copyright &copy; 2023. Mette Marie the developer all rights
      reserved
    </p>
    <div id="connect">
      <a
